...
REM --- 2. Start Telegram Bot with Cloudflare tunnel helper ---
echo [2/3] Launching Telegram Bot (with Cloudflare tunnel)...
start "MERaLiON Telegram Bot" cmd /k "cd /d ""App Part\backend"" && call .venv\Scripts\activate.bat && python run_bot_with_tunnel.py"
